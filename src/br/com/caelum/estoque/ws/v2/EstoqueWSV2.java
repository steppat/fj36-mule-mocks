package br.com.caelum.estoque.ws.v2;
...
@WebService(targetNamespace="http://caelum.com.br/estoquews/v2", serviceName="EstoqueWS",wsdlLocation="EstoqueWS_v2.wsdl")
@HandlerChain(file="handlers.xml")
public class EstoqueWSV2 {
	...
	public List<ItemEstoque> getQuantidade(
		...
		System.out.println("EstoqueWS V2 - " + codigos);
